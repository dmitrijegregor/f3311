...
static int kpd_pdrv_probe(struct platform_device *pdev)
{
	...
	/*KEYPAD S config volume down gpio to correct mode */
	kpd_info("Config volume down!\n");
	mt_set_gpio_mode(85, GPIO_MODE_01);
	/*KEYPAD E config volume down gpio to correct mode */
