...
//#define CONFIG_TOUCHSCREEN_HIMAX_DEBUG 20151215 mask
...
#define HX_TOUCH_REC //if it is enabled,touch panel will auto recover touch data like MXPT
			//when it was detect warong on TS_WORK 20160420 add recover function

//======================================== add fw_version node 20160119
#define HX_TP_FWVERSION_CHECK
#ifdef HX_TP_FWVERSION_CHECK
#define HIMAX_PROC_FWVERSION_FILE "fw_version"
static struct proc_dir_entry *himax_proc_fwversion_file = NULL;
#endif
//======================================== add fw_state node 20160119
#define HX_TP_FWSTATE_CHECK
#ifdef HX_TP_FWSTATE_CHECK
#define HIMAX_PROC_FWSTATE_FILE "fw_state"
#define HIMAX_PROC_INTSTATE_FILE "int_state" //20160425
static struct proc_dir_entry *himax_proc_fwstate_file = NULL;
static struct proc_dir_entry *himax_proc_intstate_file = NULL;
#endif
//======================================== add TPID_CHECK 20160201
#define CHECK_CTP_ID  1 // check CTP ID
#define HX_TPID_CHECK
#ifdef HX_TPID_CHECK
#define HIMAX_PROC_TPID_CHECK_FILE "tpid_check"
static struct proc_dir_entry *himax_proc_tpid_check_file = NULL;
#endif
//========================================
#else
#define D(x...) 
...
#define HX_AUTO_UPDATE_FW //20151215 mask
//#define HX_AUTO_UPDATE_CONFIG		//if enable HX_AUTO_UPDATE_CONFIG, need to disable HX_LOADIN_CONFIG
//#define HX_SMART_WAKEUP //20151215 mask
//#define HX_DOT_VIEW
//#define HX_PALM_REPORT
#define HX_ESD_WORKAROUND //20160419 unmask
...
struct himax_ts_data {
	...
	atomic_t resume_mode;//20160517 add
	uint8_t x_channel;
	uint8_t y_channel;
...
#define GEST_PT_MAX_NUM     (128)
	...
	#define KEY_CUST_01 KEY_UP
	#define KEY_CUST_02 KEY_DOWN
	#define KEY_CUST_03 KEY_LEFT
	#define KEY_CUST_04 KEY_RIGHT
	#define KEY_CUST_05 KEY_W
	#define KEY_CUST_06 KEY_Z
	#define KEY_CUST_07 KEY_V
	#define KEY_CUST_08 KEY_O
	#define KEY_CUST_09 KEY_M
	#define KEY_CUST_10 KEY_C
	#define KEY_CUST_11 KEY_E
	#define KEY_CUST_12 KEY_S
