...
static void init_lcm_registers_cpt(void)
{
	...
	data_array[2] = 0x2D2C261F;
	data_array[3] = 0x7469572D;
	data_array[4] = 0x8B877874;
	data_array[5] = 0xA4A09C8F;
	data_array[6] = 0x5C5AB8AC;
	data_array[7] = 0x706C6860;
	data_array[8] = 0x0C007F78;
	data_array[9] = 0x2C261F18;
	data_array[10] = 0x69572D2D;
	data_array[11] = 0x87787474;
	data_array[12] = 0xA09C8F8B;
	data_array[13] = 0x5AB8ACA4;
	data_array[14] = 0x6C68605C;
	data_array[15] = 0x007F7870;
	dsi_set_cmdq(data_array, 16, 1);
...
static void init_lcm_registers_cy33(void)
{
	unsigned int data_array[16];
	//0xB9,0xFF,0x83,0x94;
	printk("%s - start\n",__func__);
	...
	//0xB1,0x48,0x10,0x72,0x09,0x31,0x54,0x71,0x31,0x50,0x34
	data_array[0] = 0x000B3902;
	data_array[1] = 0x721048B1;
	data_array[2] = 0x71543109;
	data_array[3] = 0x00345031;
	dsi_set_cmdq(data_array, 4, 1);
	...
	data_array[1] = 0x247674B4;
	data_array[2] = 0x015B5A7C;
	data_array[3] = 0x0077860C;
	data_array[4] = 0x2476743F;
	data_array[5] = 0x015B5A7C;
	data_array[6] = 0x003F8605;
	data_array[7] = 0x818181EF;
	data_array[8] = 0x01088137;
	...
	/*0xE0,0x00,0x0A,0x17,
	  ...
	  0x6F,0x78,0x7F*/
	data_array[0] = 0x003B3902;
	data_array[1] = 0x170A00E0;
	data_array[2] = 0x2C27221F;
	data_array[3] = 0x7968572A;
	data_array[4] = 0xA29B8779;
	data_array[5] = 0xB8BCB8AA;
	data_array[6] = 0x6B6BD9C8;
	data_array[7] = 0x7B75736F;
	data_array[8] = 0x07007F7F;
	data_array[9] = 0x1C18160F;
	data_array[10] = 0x50401F21;
	data_array[11] = 0x836E5F60;
	data_array[12] = 0xA7A09188;
	data_array[13] = 0x60C3B3A3;
	data_array[14] = 0x6966625E;
	data_array[15] = 0x007F786F;
	dsi_set_cmdq(data_array, 16, 1);
	...
	MDELAY(120);
        ...
        //0xB2,0x00,0x80,0x64,0x10,0x07,0x2F,0x00,0x00,0x00,0x00,0xC0,0x18
        data_array[0] = 0x000D3902;
	data_array[1] = 0x648000B2;
	data_array[2] = 0x002F0710;
        data_array[3] = 0xC0000000;
...
static void lcm_get_params(LCM_PARAMS *params)
{
		...
		if(get_cei_hw_id() < CEI_HW_DVT1)
		{
			if(get_cei_project_id() == CEI_PROJECT_CY32)
			{ //PMMA
...
static void lcm_init(void)
{
	...
	MDELAY(5);
#else
	mt_set_gpio_mode(GPIO_KTD2151_ENP_EN, 0);
	mt_set_gpio_dir(GPIO_KTD2151_ENP_EN, 1);
	mt_set_gpio_out(GPIO_KTD2151_ENP_EN, 1);
	MDELAY(5);
	mt_set_gpio_mode(GPIO_KTD2151_ENN_EN, 0);
	mt_set_gpio_dir(GPIO_KTD2151_ENN_EN, 1);
	mt_set_gpio_out(GPIO_KTD2151_ENN_EN, 1);
	MDELAY(5);
#endif
#endif
       if(get_cei_hw_id() < CEI_HW_DVT1 ) {
	...
	{
		if(get_cei_project_id() == CEI_PROJECT_CY32)
			init_lcm_registers(); //PMMA
		else
			init_lcm_registers_cpt();  //glass
  }
  else
  {
  			init_lcm_registers_cy33();  //glass
  }
	MDELAY(20);
#ifdef LCM_USE_PIN_CTL
	set_gpio_lcd_bkl(1);
#else
	mt_set_gpio_mode(GPIO_LCD_LED_EN, 0);
	mt_set_gpio_dir(GPIO_LCD_LED_EN, 1);
	mt_set_gpio_out(GPIO_LCD_LED_EN, 1);
...
static void lcm_suspend(void)
{
	...
	mt_set_gpio_mode(GPIO_LCD_LED_EN, 0);
	mt_set_gpio_dir(GPIO_LCD_LED_EN, 1);
	mt_set_gpio_out(GPIO_LCD_LED_EN, 0);
#endif
	...
	mt_set_gpio_mode(GPIO_KTD2151_ENN_EN, 0);
	mt_set_gpio_dir(GPIO_KTD2151_ENN_EN, 1);
	mt_set_gpio_out(GPIO_KTD2151_ENN_EN, 0);
#endif
	//SET_RESET_PIN(0);
	MDELAY(1);
#ifdef LCM_USE_PIN_CTL
	...
	mt_set_gpio_mode(GPIO_KTD2151_ENP_EN, 0);
	mt_set_gpio_dir(GPIO_KTD2151_ENP_EN, 1);
	mt_set_gpio_out(GPIO_KTD2151_ENP_EN, 0);
