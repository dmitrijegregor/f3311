...
#define SENSOR_TYPE_MAGNETIC_FIELD_UNCALIBRATED		14	// Grace add for uncaliMag
...
#define ID_MAGNETIC_UNCALIBRATED		(ID_BASE+SENSOR_TYPE_MAGNETIC_FIELD_UNCALIBRATED-1)	// Grace add for uncaliMag
...
#define SENSOR_MAGNETIC_UNCALIBRATED	(1 << ID_MAGNETIC_UNCALIBRATED)	// Grace add for uncaliMag
...
#define EVENT_SENSOR_MAGNETIC_FIELD_UNCALIBRATED	SENSOR_MAGNETIC_UNCALIBRATED	// Grace add for uncaliMag
