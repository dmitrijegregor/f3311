...
/* jonny IOCTLs for GME60X device */ 
...
/*COMPAT IOCTLs for GME60X device */
...
/*---------------------ALSPS STK--------------------------------------------*/
#define ALSPS_IOCTL_SET_CALI_CCI                 _IOW(ALSPS, 0x17, int)  
#define ALSPS_SET_THD                 _IOW(ALSPS, 0x18, int) 
#define ALSPS_GET_INTERRUPT_COUNT     _IOR(ALSPS, 0x19, int) 
