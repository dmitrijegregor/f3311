...
printk(">>>set_fault_state start");

#ifdef CCI_KLOG_CRASH_SIZE
#if CCI_KLOG_CRASH_SIZE
	//set_fault_state(level, type, fault_name(fsr));
	set_fault_state(level, type, str);
#endif // #if CCI_KLOG_CRASH_SIZE
#endif // #ifdef CCI_KLOG_CRASH_SIZE

printk(">>>set_fault_state end");
		...
		struct pt_regs *regs)
{
	...
	kprintk("err_code=0x%X, fault_level=0x%X, fault_type=%d, fault_msg=%d\n", code, level, type, fsr);
#endif // #if CCI_KLOG_CRASH_SIZE
#endif // #ifdef CCI_KLOG_CRASH_SIZE
